...
/* harmony import */ var src_app_widgets_xa_paginator_xa_paginator_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../widgets/xa-paginator/xa-paginator.component */ 29685);
...
function CustomerDetailsComponent_section_12_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵelementStart"](0, "div", 22)(1, "xa-paginator", 23, 24);
    _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("paginationChange", function CustomerDetailsComponent_section_12_div_4_Template_xa_paginator_paginationChange_1_listener($event) {
...
function CustomerDetailsComponent_section_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵelement"](3, "xa-table", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵelementEnd"]();
...
function CustomerDetailsComponent_section_13_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵelementStart"](0, "div", 22)(1, "xa-paginator", 23, 24);
    _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("paginationChange", function CustomerDetailsComponent_section_13_div_4_Template_xa_paginator_paginationChange_1_listener($event) {
...
const caseStatusMapper = src_app_config_route_mapper_repair_status_mapper__WEBPACK_IMPORTED_MODULE_4__.CaseStatusMapper;
const repairStatusMapper = src_app_config_route_mapper_repair_status_mapper__WEBPACK_IMPORTED_MODULE_4__.RepairStatusMapper;
class CustomerDetailsComponent {
  ...
  */
  constructor(monitorService, customerService, route, commonService, router, xaCurrencyPipe) {
    ...
    this.paginationRepair = src_app_widgets_xa_paginator_xa_paginator_component__WEBPACK_IMPORTED_MODULE_1__.defaultPagination;
    ...
    this.paginationCase = src_app_widgets_xa_paginator_xa_paginator_component__WEBPACK_IMPORTED_MODULE_1__.defaultPagination;
  ...
  static #_ = this.currentPageRepair = 1;
  static #_2 = this.currentPageCase = 1;
  /**
  ...
  */
  ...
  static #_4 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_15__.NgIf, _widgets_chq_tabs_chq_tabs_chq_tabs_component__WEBPACK_IMPORTED_MODULE_9__.ChqTabsComponent, _widgets_xa_table_xa_table_component__WEBPACK_IMPORTED_MODULE_10__.XaTable, src_app_widgets_xa_paginator_xa_paginator_component__WEBPACK_IMPORTED_MODULE_1__.XaPaginator, _angular_material_icon__WEBPACK_IMPORTED_MODULE_16__.MatIcon, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_17__.MatAccordion, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_17__.MatExpansionPanel, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_17__.MatExpansionPanelHeader, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_17__.MatExpansionPanelTitle, _angular_common__WEBPACK_IMPORTED_MODULE_15__.DatePipe, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_18__.TranslatePipe, src_app_helper_pipe_xa_currency_xa_currency_pipe__WEBPACK_IMPORTED_MODULE_8__.XaCurrencyPipe],
    styles: [".main-customer-details[_ngcontent-%COMP%] {\n  height: calc(100vh - (5px + 1vw) - 110px);\n}\n.main-customer-details[_ngcontent-%COMP%]   .table-section[_ngcontent-%COMP%] {\n  overflow-y: auto;\n}\n.main-customer-details[_ngcontent-%COMP%]   .border-bottom[_ngcontent-%COMP%] {\n  border-bottom: 1px solid var(--xa-gray);\n}\n.main-customer-details[_ngcontent-%COMP%]   .header[_ngcontent-%COMP%] {\n  margin-bottom: 40px;\n  min-height: 64px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .pagination-wrapper[_ngcontent-%COMP%] {\n  margin-top: 15px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .back-section[_ngcontent-%COMP%] {\n  margin-bottom: 17px;\n  text-transform: capitalize;\n  cursor: pointer;\n}\n.main-customer-details[_ngcontent-%COMP%]   .back-section[_ngcontent-%COMP%]     mat-icon {\n  margin-left: 5px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%] {\n  width: 32%;\n  position: absolute;\n  right: 0;\n  top: 9px;\n  z-index: 1;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%] {\n  font-weight: 700;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   .sub-heading[_ngcontent-%COMP%] {\n  font-weight: 500;\n  font-size: 9px;\n  color: var(--xa-black-medium);\n  margin-bottom: 0px;\n  margin-top: 5px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   .sub-heading[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  color: var(--xa-black);\n  opacity: 0.6;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   .expanded-sub-heading[_ngcontent-%COMP%] {\n  font-weight: 400;\n  font-size: 10px;\n  color: var(--xa-black-medium);\n  margin-bottom: 0px;\n  margin-top: 8px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   .expanded-sub-heading[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  color: var(--xa-black);\n  opacity: 0.6;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   mat-panel-title[_ngcontent-%COMP%] {\n  flex-direction: column;\n  align-items: flex-start;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   mat-expansion-panel-header[_ngcontent-%COMP%] {\n  padding: 8px 20px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%] {\n  border-radius: 11px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   .mat-expansion-panel-body[_ngcontent-%COMP%] {\n  padding: 0 20px 16px;\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]     .mat-expansion-indicator::after {\n  color: var(--xa-black);\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   .mat-expansion-panel[_ngcontent-%COMP%] {\n  background: var(--xa-bold-gray);\n}\n.main-customer-details[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%]   .mat-expanded[_ngcontent-%COMP%] {\n  background: var(--xa-white);\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
/* harmony import */ var _widgets_chq_dropdown_chq_dropdown_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../widgets/chq-dropdown/chq-dropdown.component */ 8851);
...
function CustomerTableComponent_div_9_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵelementStart"](0, "div", 30)(1, "xa-paginator", 31, 32);
    _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵlistener"]("paginationChange", function CustomerTableComponent_div_9_div_3_Template_xa_paginator_paginationChange_1_listener($event) {
...
function CustomerTableComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵelement"](2, "xa-table", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵelementEnd"]();
...
function CustomerTableComponent_div_10_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵelementStart"](0, "div", 30)(1, "xa-paginator", 31, 33);
    _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵlistener"]("paginationChange", function CustomerTableComponent_div_10_div_3_Template_xa_paginator_paginationChange_1_listener($event) {
...
class CustomerTableComponent {
  ...
  constructor(monitorService, commonService, tableDataSer, router, route, caseService, xaCurrencyPipe, calendarService) {
    ...
    this.paginationCompany = src_app_widgets_xa_paginator_xa_paginator_component__WEBPACK_IMPORTED_MODULE_1__.defaultPagination;
  ...
  static #_2 = this.currentPageCompnay = 1;
  /**
   * on init
   */
  ngOnInit() {
  ...
  */
  ...
  static #_4 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdefineComponent"]({
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_19__.NgIf, _widgets_chq_input_chq_input_component__WEBPACK_IMPORTED_MODULE_10__.ChqInputComponent, _widgets_chq_dropdown_chq_dropdown_component__WEBPACK_IMPORTED_MODULE_11__.ChqDropdownComponent, _widgets_chq_button_chq_button_component__WEBPACK_IMPORTED_MODULE_12__.ChqButtonComponent, _widgets_chq_tabs_chq_tabs_chq_tabs_component__WEBPACK_IMPORTED_MODULE_13__.ChqTabsComponent, _widgets_xa_table_xa_table_component__WEBPACK_IMPORTED_MODULE_14__.XaTable, src_app_widgets_xa_paginator_xa_paginator_component__WEBPACK_IMPORTED_MODULE_1__.XaPaginator, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_20__.TranslatePipe, src_app_helper_pipe_xa_currency_xa_currency_pipe__WEBPACK_IMPORTED_MODULE_8__.XaCurrencyPipe],
    styles: [".main-customer-list {\n  height: calc(100vh - (5px + 1vw) - 110px);\n}\n.main-customer-list .header-container {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-end;\n  margin-bottom: 20px;\n}\n.main-customer-list .header-container .header-content {\n  font-weight: 600;\n  font-size: 14px;\n  line-height: 20px;\n}\n.main-customer-list .header-container .filter {\n  display: flex;\n  align-items: flex-end;\n}\n.main-customer-list .header-container .filter chq-dropdown,\n.main-customer-list .header-container .filter chq-input {\n  position: relative;\n  width: 150px;\n  margin-left: 16px;\n  margin-top: 4px;\n}\n.main-customer-list .header-container .filter chq-button {\n  margin-left: 16px;\n}\n.main-customer-list .header-container .filter chq-dropdown.user-dropdown {\n  width: 200px;\n}\n.main-customer-list .header-container .filter chq-dropdown.person-filter-dropdown, .main-customer-list .header-container .filter chq-dropdown.retail-company-filter-dropdown, .main-customer-list .header-container .filter chq-dropdown.bodyShop-filter-dropdown, .main-customer-list .header-container .filter chq-dropdown.dealerShip-filter-dropdown {\n  width: 200px;\n}\n.main-customer-list .header-container .filter chq-dropdown.company-filter-dropdown {\n  width: 170px;\n}\n.main-customer-list .delete-container {\n  display: flex;\n  justify-content: flex-end;\n  margin-top: 30px;\n  margin-bottom: 25px;\n}\n.main-customer-list .delete-container chq-button {\n  width: 180px;\n  height: 30px;\n}\n.main-customer-list .table-section {\n  overflow-y: auto;\n}\n.main-customer-list .cdk-column-status mat-icon {\n  height: 17px;\n  width: 17px;\n}\n.main-customer-list .total-due-amount {\n  padding-bottom: 18px;\n  display: flex;\n  justify-content: end;\n  font-family: Inter;\n  font-size: 18px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 24px;\n  color: var(--xa-dark-gray);\n}\n.main-customer-list .pagination-wrapper {\n  margin-top: 15px;\n}\n.main-customer-list .company-name i, .main-customer-list .company-name-dropdown i {\n  font-weight: 600;\n}\n\n.mat-sort-header-arrow {\n  margin: -2px !important;\n}\n\n.customer-list .input-wrapper {\n  position: inherit !important;\n  top: 0 !important;\n}\n\n@media (orientation: portrait) {\n  mat-cell {\n    word-break: break-word;\n  }\n  .mat-sort-header-arrow {\n    margin: 0 !important;\n  }\n}\n::-webkit-scrollbar:horizontal {\n  height: 5px;\n}\n\n.table-wrapper {\n  box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.1);\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    encapsulation: 2
  });
}
...
class CustomerTableModule {
  static #_ = this.ɵfac = function CustomerTableModule_Factory(t) {
  ...
  static #_3 = this.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjector"]({
    imports: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.CommonModule, src_app_icons_module__WEBPACK_IMPORTED_MODULE_1__.IconsModule, _angular_router__WEBPACK_IMPORTED_MODULE_10__.RouterModule.forChild(route), src_app_widgets_widgets_module__WEBPACK_IMPORTED_MODULE_2__.WidgetsModule, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__.TranslateModule, src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__.SharedModule, src_app_material_module__WEBPACK_IMPORTED_MODULE_6__.MaterialModule, src_app_helper_pipe_module__WEBPACK_IMPORTED_MODULE_7__.PipeModule]
  });
}
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](CustomerTableModule, {
    ...
    imports: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.CommonModule, src_app_icons_module__WEBPACK_IMPORTED_MODULE_1__.IconsModule, _angular_router__WEBPACK_IMPORTED_MODULE_10__.RouterModule, src_app_widgets_widgets_module__WEBPACK_IMPORTED_MODULE_2__.WidgetsModule, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__.TranslateModule, src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__.SharedModule, src_app_material_module__WEBPACK_IMPORTED_MODULE_6__.MaterialModule, src_app_helper_pipe_module__WEBPACK_IMPORTED_MODULE_7__.PipeModule]
  });
})();
