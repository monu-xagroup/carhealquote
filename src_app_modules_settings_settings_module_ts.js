...
class OperationsLayoutComponent {
  ...
  static #_ = this.ɵfac = function OperationsLayoutComponent_Factory(t) {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
    ...
    styles: [".layout-container[_ngcontent-%COMP%] {\n  height: calc(100vh - (5px + 1vw + 50px) - 60px);\n  display: flex;\n  flex-flow: column;\n}\n.layout-container[_ngcontent-%COMP%]   .tab-content[_ngcontent-%COMP%] {\n  background: var(--xa-tab-background);\n  overflow: auto;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
const settingsRoutes = [{
  ...
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme-angular_fesm2015_devextreme-angular-ui-scheduler_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_modules_settings_employee_employee_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../settings/employee/employee.module */ 8203)).then(m => m.EmployeeModule)
}];
